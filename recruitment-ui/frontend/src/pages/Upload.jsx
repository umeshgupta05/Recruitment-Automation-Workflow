    ...
    return (
      <div className="max-w-lg mx-auto animate-fade-in">
        <div className="card text-center py-10">
          ...
          <h2 className="text-xl font-bold text-neutral-100 mb-2">Resume Uploaded Successfully</h2>
          <p className="text-sm text-neutral-400 mb-1">Candidate ID: {result.candidateId}</p>
          {result.executionId && (
            <p className="text-sm text-neutral-400 mb-6">
              Workflow Execution: <code className="text-primary-400">{result.executionId}</code>
            </p>
          )}
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card flex flex-col">
            <h3 className="text-sm font-semibold text-neutral-300 mb-4">Resume PDF</h3>
            <div className="flex-1">
              <UploadZone onFile={(f) => { setFile(f); if (errors.file) setErrors((prev) => ({ ...prev, file: undefined })); }} />
            </div>
            {errors.file && (
          ...
          {/* Right — Form fields */}
          <div className="card">
            <h3 className="text-sm font-semibold text-neutral-300 mb-4">Candidate info</h3>
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-medium text-neutral-400 mb-1.5">Job title</label>
                <select
