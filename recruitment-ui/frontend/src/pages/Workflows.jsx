            ...
            <div key={wf.flowId} className="card-hover">
              ...
              <div className="flex items-center justify-between mt-4 pt-3 border-t border-neutral-700/30">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`text-xs font-medium capitalize ${cfg.text}`}
                  >
                    {cfg.label}
                  </span>
                </div>
        ...
        {runs.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-xs text-neutral-500 mt-1">
              Upload a resume to trigger the first workflow
            </p>
          </div>
        ) : (
          <table className="w-full">
            ...
            <tbody>
              {runs.map((run) => (
                <tr
                  key={run.id}
                  className="border-b border-neutral-700/20 transition-colors hover:bg-surface-tertiary/30"
                >
